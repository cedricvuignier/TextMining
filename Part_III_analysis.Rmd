...
#pivot
row_name <- c("Biden_doc", "Kamala_doc", "Trump_doc", "Vp_doc" , "H_trump_doc", "H_biden_doc")
...
row.names(Before_Tweet) <- row_name
...
## Compare the speech of Obama to the speech of Trump (target) in terms of keyness
